...
wm_path = '/home/user/PycharmProjects/workshop/modified_logos/mod_cr3.png'
origin_path = '/home/user/PycharmProjects/workshop/val/{0}.jpg'
clean_path = '/home/user/PycharmProjects/workshop/clean/{0}.jpg'
img_with_wm_path = 'watermarked/rand/{0}_mod.jpg'
...
def main():
    ...
    for i in range(1, 100):
        ...
        with WI(filename=clean_path.format(i)) as background:
            ...
            background.save(filename=img_with_wm_path.format(i))
